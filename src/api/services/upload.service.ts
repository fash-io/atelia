...
export const uploadService = {
    ...
    async uploadWorkImage({ userId, file }: { userId: string, file: File }): Promise<string> {
    ...
    async uploadAvatar({ userId, file }: { userId: string, file: File }): Promise<string> {
    ...
    async uploadApplicationFile({ userId, jobId, file, kind }:
        {
            userId: string,
            jobId: string,
            file: File,
